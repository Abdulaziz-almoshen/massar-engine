...
function systemPrompt(contact: Contact): string {
  ...
  return [
    ...
    "offer_alternative: قبل اقتراح خدمة بديلة. request_human_handoff: عند شكوى عن خدمة قائمة · مشكلة تحتاج معالجة بشرية · سؤال خارج المعرفة الرسمية · معلومة تحتاج تأكيدًا · خطوة تجارية تحتاج مختصًا.",
