...
const EXTRACT_SYSTEM = [
  ...
  "## الاعتراضات والردود",
  "## المنافسون ونقاط التميز (البدائل التي يقارن بها العميل إن ذُكرت)",
  "## الضوابط (ما لا يجوز الوعد به أو ذكره، وحدود الخدمة، إن ذُكرت)",
