...
export const SALES_STAGES: readonly SalesStage[] = [
  { key: "contact",   label: "تواصل أولي",        weightPct: 10,  position: 1, dot: "#A2A9B4", stalls: false, terminal: null,   exitCriterion: "وصلنا لصاحب القرار وأبدى اهتمامًا مبدئيًا" },
  { key: "discover",  label: "اكتشاف الحاجة",      weightPct: 25,  position: 2, dot: "#656B76", stalls: false, terminal: null,   exitCriterion: "تأكدت الحاجة والحجم وصاحب القرار والميزانية" },
  { key: "present",   label: "عرض المنتج",         weightPct: 45,  position: 3, dot: "#1E5FCC", stalls: false, terminal: null,   exitCriterion: "تم تقديم المنتج وقبول العميل للقيمة" },
  ...
  { key: "quote",     label: "عرض السعر",          weightPct: 80,  position: 5, dot: "#33373E", stalls: false, terminal: null,   exitCriterion: "تم إرسال عرض سعر مقبول مبدئيًا" },
  { key: "negotiate", label: "التفاوض والاعتماد",   weightPct: 90,  position: 6, dot: "#2563EB", stalls: true,  terminal: null,   exitCriterion: "توافق على الشروط ودخول التعاقد/المشتريات" },
