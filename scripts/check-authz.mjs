...
try {
  ...
  const ADMIN_WRITES = [
    ...
    ["GET", "/admin/campaigns/1/results"], ["GET", "/admin/partners"], ["POST", "/admin/partners"], ["PATCH", "/admin/partners/1"], ["PUT", "/admin/partners/1/targets"], ["POST", "/admin/partners/1/results"], ["PATCH", "/admin/partner-results/1"], ["DELETE", "/admin/partner-results/1"], ["GET", "/admin/kpis"], ["GET", "/admin/accounts"], ["GET", "/admin/accounts/1"], ["POST", "/admin/accounts"], ["PATCH", "/admin/accounts/1"], ["POST", "/admin/accounts/1/approval"],
